  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-400 mt-1">View your registered coffee farms</p>
      </div>
      ...
      {farms.length === 0 ? (
        <div className="bg-gray-800 rounded-xl p-12 text-center border border-gray-700">
          ...
          <p className="text-gray-600 text-sm mt-1">Contact your cooperative or exporter to add farms</p>
        </div>
      ) : (
            ...
            <div key={farm.id} className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
              <div className="p-5">
                ...
                <div className="space-y-2">
                  <p className="text-gray-300 text-sm">📍 {farm.location_description || 'No location specified'}</p>
                  {farm.altitude && <p className="text-gray-300 text-sm">⛰️ Altitude: {farm.altitude}m</p>}
                  {farm.area_hectares && <p className="text-gray-300 text-sm">📏 Area: {farm.area_hectares} ha</p>}
